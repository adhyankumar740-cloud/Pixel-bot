# main.py (Final Version: All Features Included, Pixelation Increased)
...
# Higher downscale factor means more pixelated (harder image)
GAME_LEVELS = {
    'extreme': {'downscale_factor': 20, 'points': 100, 'max_hints': 5, 'hint_cost': 10},
    'hard': {'downscale_factor': 12, 'points': 70, 'max_hints': 5, 'hint_cost': 10}, # Increased from 10
    'medium': {'downscale_factor': 7, 'points': 50, 'max_hints': 5, 'hint_cost': 10}, # Increased from 5
    'easy': {'downscale_factor': 3, 'points': 30, 'max_hints': 5, 'hint_cost': 10} # Increased from 2
}
...
# ------------------------------------------------------------------
# --- GAME COMMAND HANDLERS (UPDATED WITH EXTREME VISIBILITY LOGIC) ---
# ------------------------------------------------------------------
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    help_text = (
        ...
        "`/stats` or `/profile` - Show your personal profile/report card.\n"
        ...
        "`/album` or `/collection` - Show images you have solved/collected.\n"
        "`/skip` - Skip the current image (reveals answer).\n"
        "`/hint` - Get a free category clue.\n\n"
        
        "**🛒 Shop & Economy**\n"
        "`/daily` - Claim free daily points (once every 24h).\n"
        "`/shop` - Open the Pixel Shop to buy power-ups.\n"
        "`/buy <id>` - Purchase a power-up from the shop.\n\n"
        
        "**👑 Owner Command**\n"
        "`/broadcast <message>` - Send a message to all known chats. (Owner Only)\n\n"
...
async def about_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    about_text = (
        ...
        "✨ **Creator**: Adhyan\n"
        "✨ **Version**: 5.0 (Full Economy and Pixelation Adjustments)\n\n"
    )
